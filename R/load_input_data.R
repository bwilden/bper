...
load_surnames_data <- function(year, psuedocount = 0.1) {
...
load_first_names_data <- function(psuedocount = 0.1) {
...
load_geo_data <- function(geo_level, states = NULL, year, psuedocount = 0.1) {
