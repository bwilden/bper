...
-   `place`. 7 digit Census Place code. This is comprised of a 2-digit State code + 5-digit Place code.
...
Warning: the total size of these file is about 60 MB. If you are not using Census Blocks for your geolocation variable, set `include_blocks = FALSE` to substantially reduce the download time. For more details see `?load_bperdata` and <https://github.com/bwilden/bperdata.> Note: you do **not** need to install the `bperdata` package.
